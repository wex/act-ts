...
export default function Skillset(key: string, value: string, className: string = ''): HTMLElement {
    return createElement(
        ...
        createElement('div', {"class": "max-sm:hidden min-w-[3em] flex-auto after:border-b-2 after:border-gray-400 after:border-dotted after:block after:h-1 after:w-full after:translate-y-[250%]"}, ''),
